...
public class TestAddToAccount extends TestCase {
        ...
        public TestAddToAccount(String name) {
                super(name);
                try {
        ...
        public void testAddToAccount() throws Exception {
                try {
                        /* Login user. */
                        userFacade.login(user.getLogin(), user.getPassword(),
                                        false);

                        userFacade.addToAccount(account.getAccountID(),
                                        new Double("10.00"));

                        /* Update transfer object. */
                        account.setBalance(new Double("22.00"));
        ...
        public static void main(String[] args) {
                junit.textui.TestRunner.run(TestAddToAccount.class);
        }
