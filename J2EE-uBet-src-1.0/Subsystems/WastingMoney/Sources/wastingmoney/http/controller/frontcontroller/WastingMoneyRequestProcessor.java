 ...
 */
public class WastingMoneyRequestProcessor extends TilesRequestProcessor {

        PreProcessingFilter firstPreProcessingFilter;

        public WastingMoneyRequestProcessor() {
        ...
        protected ActionForward processActionPerform(
                ...
                if (actionForward == null) {
                        return super.processActionPerform(request, response,
                                        action, form, mapping);
                }
