...
public class TestFindProductsByUser extends TestCase {
        ...
        public TestFindProductsByUser(String name) {
                super(name);
                try {
        ...
        public void testFindAllProducts() throws Exception {
                ...
                try {
                        /* Find products. */
                        Vector<ProductResultTO> results = userFacade
                                        .findProductsByUser(seller.getLogin(),
                                                        -1, -1);
        ...
        public void testFindProductsPageByPage() throws Exception {
                ...
                try {
                        ...
                        /* Page 2. */
                        results = userFacade.findProductsByUser(seller
                                        .getLogin(), 3, 2);
        ...
        public void testFindProductsByUserWithNoProducts() throws Exception {

                try {
                        /* Find products. */
                        Vector<ProductResultTO> results = userFacade
                                        .findProductsByUser("login2", 1, 2);
        ...
        public static void main(String[] args) {
                junit.textui.TestRunner.run(TestFindProductsByUser.class);
        }
