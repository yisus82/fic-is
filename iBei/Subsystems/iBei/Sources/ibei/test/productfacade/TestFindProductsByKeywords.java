...
public class TestFindProductsByKeywords extends TestCase {
        ...
        public TestFindProductsByKeywords(String name) {
                super(name);
                try {
        ...
        public void testFindAllProducts() throws Exception {
                ...
                try {
                        ...
                        Vector<ProductResultTO> results = productFacade
                                        .findProductsByKeywords(keywords, -1,
                                                        -1);
        ...
        public void testFindProductsPageByPage() throws Exception {
                ...
                try {
                        ...
                        keywords.add("am");
                        Vector<ProductResultTO> results = productFacade
                                        .findProductsByKeywords(keywords, 1, 2);
                        ...
                        /* Page 2. */
                        results = productFacade.findProductsByKeywords(
                                        keywords, 3, 2);
        ...
        public void testFindProductsByKeywordsWithNoProducts() throws Exception {
        ...
        public static void main(String[] args) {
                junit.textui.TestRunner.run(TestFindProductsByKeywords.class);
        }
