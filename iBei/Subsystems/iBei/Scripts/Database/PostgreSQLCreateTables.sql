...
CREATE TABLE Product (productID BIGINT NOT NULL, 
    name VARCHAR(30) NOT NULL, description VARCHAR(50), endTime TIMESTAMP NOT NULL, 
    currentPrice DOUBLE PRECISION NOT NULL, startTime TIMESTAMP NOT NULL, 
    startingPrice DOUBLE PRECISION NOT NULL, shippingInfo VARCHAR(100) NOT NULL,
    categoryID VARCHAR(10) NOT NULL, userID VARCHAR(30) NOT NULL, winnerID VARCHAR(30), 
    winnerBid DOUBLE PRECISION,
...
CREATE INDEX ProductIndexByDate ON Product (productID, endDate);
...
CREATE TABLE Bid (bidID BIGINT NOT NULL, userID VARCHAR(30) NOT NULL,
	productID BIGINT NOT NULL, currentBid DOUBLE PRECISION NOT NULL, maxBid DOUBLE PRECISION NOT NULL, 
...
CREATE TABLE Increment (minValue DOUBLE PRECISION NOT NULL, maxValue DOUBLE PRECISION NOT NULL, 
    increment DOUBLE PRECISION NOT NULL,
	CONSTRAINT IncrementRankPK PRIMARY KEY (minValue));
...
CREATE TABLE Vote (voteID BIGINT NOT NULL, rating INT NOT NULL,
